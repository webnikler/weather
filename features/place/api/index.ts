...
export const getAddressByCoordinates = async (payload: AddressPayload): Promise<AddressResponse> => {
  return useApi.post<AddressPayload, AddressResponse>(ADDRESS_BASE_URL, payload, {
